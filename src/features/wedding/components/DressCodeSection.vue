  ...
  >
    <div class="max-w-5xl mx-auto px-6">
      ...
      >
        ...
        <PaperCard shape="left" class="w-full max-w-md mx-auto">
          ...
          >
            ...
            <div class="flex justify-center items-center gap-4">
              ...
              ></div>
              <div
                class="w-10 h-10 rounded-full bg-[#f3d5b5] border border-gold/20 shadow-sm"
                title="Crema"
              ></div>
              <div
              ...
              ></div>
              <div
                class="w-10 h-10 rounded-full bg-[#d6ab83] border border-gold/20 shadow-sm"
                title="Nude"
              ></div>
            </div>
          </div>
        ...
        <PaperCard shape="right" class="w-full max-w-md mx-auto">
          <div
            class="w-full text-center flex flex-col items-center justify-center py-4 my-auto"
          >
